...
/**  
* @function
* TODO: Playing around with toggling between the two play algorithms below by having the other one disabled being named to play1 rather than play. 
...
*
*/
NotesPlayer.prototype.play2 = function (note, octave = 0, bpm = 60, durationSecondsPerBeat = 1 / (bpm / 60)) {
  let context = this.context,
    freq = this.NOTES[note],
    octaveFactor = Math.pow(2, octave);
